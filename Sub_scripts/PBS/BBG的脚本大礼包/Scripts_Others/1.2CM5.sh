...
#
# Optimization and calculation of CM5 charges will be conducted in vaccum under B3LYP-D3(BJ)/def2-SVP level
# The finally produced 1.2*CM5 charges are very suitable for OPLS-AA forcefield
