...
model_params = {'solver':'lbfgs', 'random_state':0, 'activation':'relu', 'max_iter':10000}
...
# column_trans = ColumnTransformer(
                         # [
                          # ('ohe', OneHotEncoder(categories=[ZnO2,DC01,DC01T,ZnO1,WS,PCZ70,SL7025], sparse=False), columns_list)],
...
'''Pipeline parameters'''
pipe_params_tests =  [{ 'mlpr__hidden_layer_sizes':[(i,i,i,i) for i in range(10,40,1)
                                                   ]},
                      { 'mlpr__hidden_layer_sizes':[(i,i,i,i,i) for i in range(10,50,1)
                     ]},
                      { 'mlpr__hidden_layer_sizes':[(i,i,i,i,i,i) for i in range(10,50,1)
                     ]},
                      { 'mlpr__hidden_layer_sizes':[(i,i,i,i,i,i,i) for i in range(10,50,1)
                     ]},
                      { 'mlpr__hidden_layer_sizes':[(i,i,i,i,i,i,i,i) for i in range(10,50,1)
                     ]}
                     ]
