...
'''Pipeline parameters'''
pipe_params_tests =  [{ 'svr__kernel':['rbf'],
                        'svr__C':[0.01,0.1,1,3,10,30,100],
                        'svr__gamma':[0.01,0.03,0.1,0.3,1],
                        'svr__epsilon':[0.01,0.03,0.1,0.3,1]},
                      { 'svr__kernel':['linear'],
                        'svr__C':[0.01,0.1,1,3,10,30],
                        'svr__gamma':[0.01,0.03,0.1,0.3],
                        'svr__epsilon':[0.01,0.03,0.1,0.3]},
                      { 'svr__kernel':['poly'],
                        'svr__degree':[2,3,4],
                        'svr__C':[0.01,0.1,1,2,3,5,8,10,100],
                        'svr__gamma':[0.03,0.05,0.08,0.1,0.3,1],
                        'svr__epsilon':[0.001,0.005,0.01,0.02,0.05,0.1]}
                     ]
