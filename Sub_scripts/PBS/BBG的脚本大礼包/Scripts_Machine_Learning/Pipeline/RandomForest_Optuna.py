...
model_name = "RandomForestRegressor"  # "RandomForestRegressor" or "RandomForestClassifier"
...
pipe_params = {}  
pipe_params['rfr__n_estimators'] = optuna.distributions.IntUniformDistribution(50,150,5)
pipe_params['rfr__max_features'] = optuna.distributions.CategoricalDistribution(['auto','sqrt','log2'])
pipe_params['rfr__max_depth'] = optuna.distributions.IntUniformDistribution(2,10,1)
pipe_params['rfr__min_samples_split'] = optuna.distributions.IntUniformDistribution(2,4,1)
pipe_params['rfr__min_samples_leaf'] = optuna.distributions.IntUniformDistribution(1,4,1)
pipe_params['rfr__bootstrap'] = optuna.distributions.CategoricalDistribution([True, False])
pipe_params['rfr__ccp_alpha'] = optuna.distributions.UniformDistribution(0,5)
