...
pipe_params = {}
pipe_params['en__fit_intercept'] = optuna.distributions.CategoricalDistribution([True, False])
pipe_params['en__l1_ratio'] = optuna.distributions.UniformDistribution(0,1)
pipe_params['en__alpha'] = optuna.distributions.LogUniformDistribution(1e-5,1e3)
