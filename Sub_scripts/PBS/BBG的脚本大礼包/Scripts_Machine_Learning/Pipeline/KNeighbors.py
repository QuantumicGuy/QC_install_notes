...
def model_choice(model_name, model_params):
    ...
    if model_name == "KNeighborsClassifier":
        ...
        print('** Please choose the KNeighbors model **\n-> Supported KNeighbors models are as follows:')
        print('   (1) KNeighborsRegressor\n   (2) KNeighborsClassifier')
        exit(1)
...
searchCV_other_params = {"verbose":2, "refit":True, "cv":3, "n_jobs":-1, "scoring":'neg_mean_squared_error'}  # other parameters for "GridSearchCV" or "RandomizedSearchCV" methods: cv: k-fold cross validation; n_jobs: parallel CPU cores; n_iter=300 (for RandomizedSearchCV) "scoring":'neg_mean_squared_error' or 'accuracy'

'''model parameters'''
model_name = "KNeighborsRegressor"  #  "KNeighborsRegressor" and "KNeighborsClassifier" 
model_params = {}
...
'''Pipeline parameters'''
pipe_params_tests =  [{ 'knr__n_neighbors':range(3,10,1)},
                     ]
