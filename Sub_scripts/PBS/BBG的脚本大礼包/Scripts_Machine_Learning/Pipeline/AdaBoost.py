...
pipe_params_tests =  [{ 'abr__n_estimators':range(85,100,1),
                        'abr__learning_rate':[0.001,0.002,0.004,0.008,0.01,0.02,0.05],
                        'abr__base_estimator':[DecisionTreeRegressor(max_depth=4, max_features=6)]
                        }
                     ]
