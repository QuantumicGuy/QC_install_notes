...
pipe_params = {} 
pipe_params['svr__kernel'] = optuna.distributions.CategoricalDistribution(choices=['rbf','linear','poly'])
pipe_params['svr__C'] = optuna.distributions.LogUniformDistribution(1e-5, 1e3)
pipe_params['svr__gamma'] = optuna.distributions.LogUniformDistribution(1e-5, 1e3)
pipe_params['svr__epsilon'] = optuna.distributions.LogUniformDistribution(1e-5, 1e3)
if pipe_params["svr__kernel"] == "poly": 
    pipe_params["svr__degree"] = optuna.distributions.IntUniformDistribution(2, 4)
