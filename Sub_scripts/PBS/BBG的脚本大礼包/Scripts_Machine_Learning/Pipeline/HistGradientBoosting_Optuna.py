...
model_name = "HistGradientBoostingRegressor"  #  "HistGradientBoostingRegressor" or "HistGradientBoostingClassifier"
...
pipe_params = {}
pipe_params['hgbr__max_iter'] = optuna.distributions.IntUniformDistribution(50,150,5)
pipe_params['hgbr__max_leaf_nodes'] = optuna.distributions.IntUniformDistribution(30,100,5)
pipe_params['hgbr__max_depth'] = optuna.distributions.IntUniformDistribution(2,8,1)
pipe_params['hgbr__min_samples_leaf'] = optuna.distributions.IntUniformDistribution(1,30,1)
pipe_params['hgbr__l2_regularization'] = optuna.distributions.LogUniformDistribution(1e-6,1e3)
