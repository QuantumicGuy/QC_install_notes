...
def model_choice(model_name, model_params):
    ...
    if model_name == "BaggingRegressor":
        ...
        print('** Please choose a Bagging model **\n-> Supported Bagging models are as follows:')
        print('   (1) BaggingRegressor\n   (2) BaggingClassifier')
        exit(1)
...
model_name = "BaggingRegressor"  #  "BaggingRegressor" or "BaggingClassifier"
...
pipe_params = {}
pipe_params['br__base_estimator'] = optuna.distributions.CategoricalDistribution(
...
pipe_params['br__n_estimators'] = optuna.distributions.IntUniformDistribution(85,120,1)
pipe_params['br__max_samples'] = optuna.distributions.IntUniformDistribution(17,20,1)
pipe_params['br__max_features'] = optuna.distributions.CategoricalDistribution([7,6,5,4,3])
#pipe_params['br__bootstrap_features'] = optuna.distributions.CategoricalDistribution([False, True])
