...
pipe_params_tests =  [{ 'br__n_estimators':range(85,120,1),
                        'br__max_samples':[17,18,19,20],
                        'br__max_features':[1.0],
                        'br__bootstrap_features':[False],
                        'br__base_estimator':[DecisionTreeRegressor(max_depth=4)]
                        }
                     ]
