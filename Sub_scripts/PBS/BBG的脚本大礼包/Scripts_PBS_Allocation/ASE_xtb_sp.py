...
print('-> Task name:  %52s' %name)
print('-> Orthorhombic cell parameters:  %33s' %mol.get_cell())
print('-> Total number of atoms in a cell:  %30s' %total_atoms)
print('-> PBC dimensions:  %47s' %mol.get_pbc())
